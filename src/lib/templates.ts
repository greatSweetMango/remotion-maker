...
export async function getTemplates(): Promise<Template[]> {
  ...
  _templates = await Promise.all([
    ...
    loadTemplate('BezierPath.tsx', {
      id: 'bezier-path',
      title: 'Bezier Path',
      description: 'Stroke-on bezier curve with gradient, echo trail, head dot',
      category: 'background',
      durationInFrames: 360,
      fps: 60,
      width: 1920,
    ...
    loadTemplate('GlitchEffect.tsx', {
      id: 'glitch-effect',
      title: 'Glitch Effect',
      description: 'RGB-split chromatic aberration headline with scan lines + tear bands',
      category: 'text',
    ...
    loadTemplate('LiquidWave.tsx', {
      id: 'liquid-wave',
      title: 'Liquid Wave',
      description: 'Layered sine waves with iridescent gradient — fluid background loop',
      category: 'background',
      durationInFrames: 480,
      fps: 60,
      width: 1920,
    ...
    loadTemplate('Constellation.tsx', {
      id: 'constellation',
      title: 'Constellation',
      description: 'Drifting starfield with proximity-linked tech-network lines',
      category: 'background',
      durationInFrames: 480,
      fps: 60,
      width: 1920,
    ...
    loadTemplate('HolographicCard.tsx', {
      id: 'holographic-card',
      title: 'Holographic Card',
      description: 'Floating iridescent card with conic shimmer + perspective tilt',
      category: 'logo',
      durationInFrames: 360,
      fps: 60,
      width: 1920,
