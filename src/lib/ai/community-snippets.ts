/**
 * TM-141 — Community-style reference SNIPPETS (data only).
 *
 * Original, MIT-equivalent minimal exemplars (50-150 LOC each) that show the
 * canonical structure of each community category. Pure string constants — no
 * runtime logic, no fs reads, no npm dependency. Each snippet exports a
 * `PARAMS` const (ADR-0002), uses `useCurrentFrame`, and returns an
 * `<AbsoluteFill>` root.
 *
 * TM-183 (2026-06-04): extracted verbatim from `community-templates.ts` to
 * split the 650-LOC god-module into data (this file) + catalog + logic.
...
export const CHARACTER_SCENE = `import { AbsoluteFill, useCurrentFrame, interpolate, spring, useVideoConfig } from 'remotion';
...
export const HELLO_WORLD = `import { AbsoluteFill, useCurrentFrame, interpolate, spring, useVideoConfig } from 'remotion';
...
export const AUDIOGRAM = `import { AbsoluteFill, useCurrentFrame, useVideoConfig } from 'remotion';
...
export const CAPTIONS = `import { AbsoluteFill, useCurrentFrame } from 'remotion';
...
export const THREE_D_CARD = `import { AbsoluteFill, useCurrentFrame, interpolate } from 'remotion';
...
export const APPLE_WOW = `import { AbsoluteFill, useCurrentFrame, interpolate, spring, useVideoConfig } from 'remotion';
...
export const TAILWIND_STYLE = `import { AbsoluteFill, useCurrentFrame, spring, useVideoConfig } from 'remotion';
...
export const STOCK_TICKER = `import { AbsoluteFill, useCurrentFrame, interpolate } from 'remotion';
...
export const AUDIO_REACT_PULSE = `import { AbsoluteFill, useCurrentFrame } from 'remotion';
...
export const SEQUENCE_COMP = `import { AbsoluteFill, Sequence, useCurrentFrame, spring, useVideoConfig } from 'remotion';
